...
import { ThumbsUp, Heart, Laugh, Meh } from "lucide-react";
...
export default function UltimaVoxaLanding() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-4 py-10">
      ...
      >
        Cyber-Memorial of Humanity. Laisse un message symbolique, illustré par l'art de l'IA.
      </motion.p>
      ...
      >
        Chaque message devient une œuvre. Une image cyberpunk, une trace pour l’éternité.
      </motion.div>
